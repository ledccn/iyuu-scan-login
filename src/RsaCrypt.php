...
class RsaCrypt
{
    ...
    /**
     * 非对称私钥签名算法与非对称公钥验签算法（OPENSSL_ALGO_SHA256 或 OPENSSL_ALGO_SHA1）
     * @var int
     */
    ...
    public function __construct(
         ...
         string $hmac_algo = 'sha256',
         int    $openssl_sign_algorithm = OPENSSL_ALGO_SHA1,
         int    $expires_in = 30
    )
    {
        ...
        $this->openssl_sign_algorithm = $openssl_sign_algorithm;
